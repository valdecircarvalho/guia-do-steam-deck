...
1. [Getting Started with RPCS3](https://github.com/dragoonDorise/EmuDeck/wiki/rpcs3#getting-started-with-rpcs3)
      - [Configuration](https://github.com/dragoonDorise/EmuDeck/wiki/rpcs3#configuration)
      - [How to Update RPCS3](https://github.com/dragoonDorise/EmuDeck/wiki/rpcs3#how-to-update-rpcs3)
      - [How to Launch RPCS3 in Desktop Mode](https://github.com/dragoonDorise/EmuDeck/wiki/rpcs3#how-to-update-rpcs3)
      - [File Formats](https://github.com/dragoonDorise/EmuDeck/wiki/rpcs3#file-formats)
      - [Hotkeys](https://github.com/dragoonDorise/EmuDeck/wiki/rpcs3#hotkeys)

2. [RPCS3 Tips and Tricks](https://github.com/dragoonDorise/EmuDeck/wiki/rpcs3#rpcs3-tips-and-tricks)
      - [How to Configure RPCS3 For EmulationStation-DE](https://github.com/dragoonDorise/EmuDeck/wiki/rpcs3#how-to-configure-rpcs3-for-emulationstation-de)
      - [Special Game Configurations](https://github.com/dragoonDorise/EmuDeck/wiki/rpcs3#special-game-configurations)

***

# Getting Started with RPCS3
[Back to the Top](https://github.com/dragoonDorise/EmuDeck/wiki/rpcs3#rpcs3-table-of-contents)
...
Read the [Configuration](#configuration) section to learn more about RPCS3 and its folder locations. 
...
* `EmulationStation-DE`
  * To play PS3 games in EmulationStation-DE, read: [How to Configure RPCS3 For EmulationStation-DE](https://github.com/dragoonDorise/EmuDeck/wiki/rpcs3#how-to-configure-rpcs3-for-emulationstation-de) 
...
2. Either: 
   ...
   * For more information, read the [File Formats](https://github.com/dragoonDorise/EmuDeck/wiki/rpcs3#file-formats) section
...
8. Your game should now show launch directly from EmulationStation-DE
